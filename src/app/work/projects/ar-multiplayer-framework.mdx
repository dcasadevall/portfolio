...
textOverlays:
  - title: "Shared AR Experience"
    subtitle: "Multiple users can see and interact with the same AR content"
    startTime: 0
    duration: 5
  - title: "Cross-Platform Support"
    subtitle: "Unified backend supporting both Unity mobile and web-based AR applications"
    startTime: 7
    duration: 5
  - title: "Real-time Synchronization"
    subtitle: "Advanced clock synchronization and client interpolation systems"
    startTime: 14
    duration: 5
  - title: "Scalable Architecture"
    subtitle: "Streamlined multiplayer service with reduced operational costs"
    startTime: 21
    duration: 5
---
